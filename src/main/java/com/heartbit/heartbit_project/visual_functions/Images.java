...
public class Images {
    ...
    public static void HomeEnabled(ImageView homeImg, ImageView accountImg, ImageView resultsImg) {
    ...
    public static void AccountEnabled(ImageView homeImg, ImageView accountImg, ImageView resultsImg) {
    ...
    public static void ResultsEnabled(ImageView homeImg, ImageView accountImg, ImageView resultsImg) {
        homeImg.setImage(new Image(Objects.requireNonNull(Images.class.getResource(pakage+"/images/icons/normal/Home.png")).toExternalForm()));
        accountImg.setImage(new Image(Objects.requireNonNull(Images.class.getResource(pakage+"/images/icons/normal/Person.png")).toExternalForm()));
    ...
    public static void BluetoothEnabled(ImageView homeImg, ImageView accountImg, ImageView resultsImg) {
        homeImg.setImage(new Image(Objects.requireNonNull(Images.class.getResource(pakage+"/images/icons/normal/Home.png")).toExternalForm()));
        accountImg.setImage(new Image(Objects.requireNonNull(Images.class.getResource(pakage+"/images/icons/normal/Person.png")).toExternalForm()));
        resultsImg.setImage(new Image(Objects.requireNonNull(Images.class.getResource(pakage+"/images/icons/normal/Results.png")).toExternalForm()));
    }
